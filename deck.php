...
function archetypeDropMenu($def="") {
  ...
  echo "<select class=\"inputbox\" id=\"deck-archetype\" name=\"archetype\">\n";
    ...
    foreach ($matches as $match) {
        ...
        if($match->timing > 1 && $match->type == 'Single Elimination') {
         ...
         if ($res != 'Bye'){
                ...
                if (!$event->active && $event->finalized) {echo "<td align=\"right\">$deckcell&nbsp;</td></tr>\n";}    
         } else {
             echo "<tr><td align=\"right\">$rnd:&nbsp;</td>\n";
