...
See `docs/MODERNIZATION.md` for how to pick one up.

## At a glance

581 tasks, 0 marked done.
...
- [ ] `T-B3C3A9` (bug/medium) PHP Warning should end a test. You can try and read an array key that doesn't exist on a dict as a repro case
...
- [ ] `T-7F07F4` (test/medium) Figure out why PHP Warnings don't cause test failures
...
- [ ] `T-E627F3` (test/medium) composer test shold proxy along args
- [ ] `T-E782DF` (types/medium) must run phpstan and psalm on ci/ci
...
- [ ] `T-B3C3A9` (medium) **[start here]** PHP Warning should end a test. You can try and read an array key that doesn't exist on a dict as a repro case
...
- [ ] `T-E782DF` (medium) **[start here]** must run phpstan and psalm on ci/ci
...
- [ ] `T-7F07F4` (medium) **[start here]** Figure out why PHP Warnings don't cause test failures
