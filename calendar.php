...
print "VERSION:2.0\r\n";
print "PRODID:-//pauperkrew/gatherling//EN\r\n";
print "X-WR-CALNAME;VALUE=TEXT:PDCMagic Tournament Schedule\r\n";
print "X-WR-CALDESC;VALUE=TEXT:Pauper Magic Player Run Events on Magic: The Gathering Online\r\n";
