...
class EventForm extends EventFrame
{
    ...
    public array $eventThreadUrlField;
    public array $metagameUrlField;
    public array $reportUrlField;
    ...
    public array $lateEntryLimitField;
    public array $playerReportedResultsCheckbox;
    public array $registrationCapField;
